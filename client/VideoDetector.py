...
class VideoInferencePage:
    def __init__(self):
        ...
        self.CLASSES = ('__background__',  # always index 0
                            'antenna3', 'antenna2', 'antenna1', 'antenna5', 'antenna4')

        self.NETS = {'vgg16': ('VGG16',
                        'VGG16_faster_rcnn_final.caffemodel'),
                'zf': ('ZF',
                    'tm_antenna_60000.caffemodel')}
    ...
    def do_detections(self):
        ...
        prototxt = os.path.join(this_dir, 'antenna_60000.prototxt')
        caffemodel = os.path.join(this_dir, 'tm_antenna_60000.caffemodel')
        ...
        try:
            while not self.stopEvent.is_set():
                ...
                vertical_left = int((frame.shape[0] // 3)*2)
                vertical_right = int((frame.shape[0] // 2.6)*2)
                #line_x = int((frame.shape[0] // 3)*2)
                #line_x2 = int((frame.shape[0] // 2.6)*2)
                ...
                for fid in faceTrackers.keys():
                    ...
                    if fid in faceNames.keys():
                        ...
                        if y_id > vertical_left and y_id < vertical_right:
                            count = count + 1
                ...
                #cv2.line(frame, ( 0, vertical_left), (frame.shape[0], vertical_left), (0, 255, 255), 2)
                #cv2.line(frame, ( 0, vertical_right), (frame.shape[0], vertical_right), (0, 255, 255), 2)
                
                cv2.line(frame, (0, vertical_left), (frame.shape[1], vertical_left), (0, 255, 255), 2)
                cv2.line(frame, (0, vertical_right), (frame.shape[1], vertical_right), (0, 255, 255), 2)
